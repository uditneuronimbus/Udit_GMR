      ...
      <div class="press-layout desktop-layout">
        <aside class="press-filter-panel">
          ...
          <div class="filter-group filter-group-collapsible">
            ...
            <div class="filter-options hidden" id="year-options">
          ...
          <div class="mobile-filter-content">
            ...
            <div class="modal-body">
              ...
              <div class="filter-group month-group" style="display: none;">
                ...
                <label><input type="radio" name="mobile-month" value="January"> January</label>
                <label><input type="radio" name="mobile-month" value="February"> February</label>
                <label><input type="radio" name="mobile-month" value="March"> March</label>
                <label><input type="radio" name="mobile-month" value="April"> April</label>
                <label><input type="radio" name="mobile-month" value="May"> May</label>
                <label><input type="radio" name="mobile-month" value="June"> June</label>
                <label><input type="radio" name="mobile-month" value="July"> July</label>
                <label><input type="radio" name="mobile-month" value="August"> August</label>
                <label><input type="radio" name="mobile-month" value="September"> September</label>
                <label><input type="radio" name="mobile-month" value="October"> October</label>
                <label><input type="radio" name="mobile-month" value="November"> November</label>
                <label><input type="radio" name="mobile-month" value="December"> December</label>
              </div>
    ...
    mobileFilterBtns.forEach(btn => {
      ...
      switch(type) {
        case 'year-month':
          ...
          const monthText = state.month || 'March';
