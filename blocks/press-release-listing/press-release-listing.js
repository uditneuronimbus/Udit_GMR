// import { getSharedData } from '../../scripts/shared-state.js';



// export default function decorate(block) {
//   const filters = getSharedData('pressFilters');
...
//     state.subCategory = filters.subCategory;
//   }
//   console.log("__________________________", state.year);
...
export default function decorate(block) {
  ...
  console.log('All filter data:', e.detail);
});
}