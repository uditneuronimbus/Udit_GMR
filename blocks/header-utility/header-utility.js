...
function initAccessibilityModal() {
  ...
  // Add CSS styles for font size
  const style = document.createElement('style');
  style.id = 'accessibility-font-styles';
  style.textContent = `
    /* Font size levels */
.font-size--1 { font-size: 0.7em !important; }
.font-size--2 { font-size: 0.6em !important; }

.font-size-1 { font-size: 1.1em !important; }
.font-size-2 { font-size: 1.2em !important; }
...
.font-size-2 * {
  font-size: inherit !important;
    ...
    .accessibility-font-btn.active .option-checkmark,
